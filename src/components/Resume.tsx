...
export const Resume = () => {
    return (
        ...
        >
            ...
            >
                With a background in Electronics and Communication Engineering and hands-on experience in MERN development and front-end design, I’ve built projects ranging from responsive websites to dynamic web applications. Every project has strengthened my ability to create clean, functional, and user-focused digital experiences. I aim to blend performance, modern UI, and seamless usability in everything I build.
            </motion.p>
